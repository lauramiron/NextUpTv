 ...
 */
enum class SyncType {
    FULL,     // Full sync of entire catalog (maxPages = -1)
    PARTIAL,  // Partial sync with page limit (maxPages != -1)
...
data class LibrarySyncMetadataEntity(
    ...
    val updatedAt: Date,        // ISO 8601 timestamp in US/Pacific timezone stored as TEXT
    val syncType: SyncType,
    val success: Boolean,
    val services: String,       // JSON array of service names, e.g., ["netflix", "prime", "disney"]
